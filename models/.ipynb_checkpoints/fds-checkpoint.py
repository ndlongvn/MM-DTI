...
class FDS(nn.Module):
    ...
    def __init__(self, feature_dim, raw_data, col_data, use_scaler, bucket_num=100, bucket_start=0, start_update=0, start_smooth=1,
        ...
        if use_scaler:
            logger.info(f"FDS using scale values !")
...
#             value_dict[bin_index]+=1
        ...
        logger.info(f"Initialized FDS with [{bucket_num}] buckets!")
    @staticmethod
