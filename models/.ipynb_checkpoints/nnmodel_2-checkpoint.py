...
from .test_model_2 import TestModel_2
# from .test_model_2_2 import Embedding
from .test_model_4 import TestModel_4, ChembertaCustom, Chemberta
# from .test_model_2_fair import TestModel_2_Fair
from .test_model_6 import TestModel_6, SmilesBert
from .test_model_6_class import TestModel_6_class
# from .test_model_7 import TestModel_7
# from .test_model_8 import TestModel_8
# from .test_model_9 import TestModel_9
# from .test_model_10 import TestModel_10, Chemberta_1
from .test_model_6_3 import TestModel_6_3
from .test_model_6_1 import TestModel_6_1
from .test_model_6_2 import TestModel_6_2
from .test_model_6_4 import TestModel_6_4
from .test_model_10 import TestModel_10
from .mm_model import MM_Model
# from .encoder import ChembertaEncoder, UnimolEncoder

NNMODEL_REGISTER = {
    'unimolv1': UniMolModel,
    # 'test_model': TestModel,
    # 'test_model_1': TestModel_1,
    # 'test_model_2': TestModel_2,
    # 'test_model_2_fair': TestModel_2_Fair,
    # 'test_model_2_2': Embedding,
    # 'test_model_4': TestModel_4,
    # 'chemberta': Chemberta,
    # 'chemberta_1': Chemberta_1,
    # 'chemberta_custom': ChembertaCustom,
    'test_model_6': TestModel_6,
    'test_model_10': TestModel_10,
    'test_model_6_class': TestModel_6_class,
    'mm_model': MM_Model,
    # 'test_model_6_3': TestModel_6_3,
    # 'test_model_6_1': TestModel_6_1,
    # 'test_model_6_2': TestModel_6_2,
    # 'test_model_6_4': TestModel_6_4,
    'smile_bert': SmilesBert
}
...
class NNModel_2(object):
    ...
    def __init__(self, data_train, data_test, trainer, **params):
        ...
        self.using_rnc = params.get('using_rnc', False)
    ...
    def _init_model(self, model_name, **params):
        ...
        if model_name in NNMODEL_REGISTER:
            ...
            if self.freeze_model:
                model_path = os.path.join(self.load_path, 'model_0.pth')
                cpkt= torch.load(
                    model_path, map_location=self.trainer.device)['model_state_dict']
                # cpkt= {k:v for k, v in cpkt.items() if "classification_head" not in k}
                model.load_state_dict(cpkt, strict= False)
                ...
                logger.info('Load model from checkpoint from {} and freezing model'.format(model_path))
    ...
    def run(self):
        ...
        _y_pred = self.trainer.fit_predict(
            self.model, traindataset, validdataset, self.loss_func, self.activation_fn, self.save_path, 0, self.target_scaler, return_ct_loss= self.using_ct, return_rnc_loss=self.using_rnc, use_weight= self.use_weight)
