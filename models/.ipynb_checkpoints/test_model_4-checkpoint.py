...
class TestModel_4(nn.Module):
    ...
    def __init__(self, output_dim=2, config=None,**params):
        ...
        super().__init__()
        data_type='molecule'
        config=  BertConfig('/workspace1/longnd38/unimol/Uni-Mol/unimol_tools/unimol_tools/config/bert_cfg_1.json')
        self.args = molecule_architecture()
        self.output_dim = output_dim
        self.data_type = data_type
        self.remove_hs = params.get('remove_hs', False)
        ...
        self.downsample_final = nn.Linear(512*2, 512)
        self.fuse_type = 'mean'
        self.infonce= InfoNCE(512, 512)
        # self.infonce1= InfoNCE(512, 512)
