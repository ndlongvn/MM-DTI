...
# import warnings
# from .encoder import UnimolEncoder, ChembertaEncoder
...
#         self.en_attention= BertSelfEncoder(self.cross_cfg)
             
#         self.bert= ChembertaEncoder()
#         self.bert_attention= BertSelfEncoder(self.cross_cfg)
...
#         """
#         img_mask = src_tokens.ne(self.padding_idx)
#         self.encoder.eval()
#         with torch.no_grad():
#             all_repr = self.encoder(src_tokens,
#                                     src_distance,
#                                     src_edge_type)
...
#         all_repr= self.en_attention(all_repr, extended_img_mask)[-1]
...
#         text_output = self.bert_attention(text_output, extended_txt_mask)[-1]
        
#         # contrastive loss
#         if return_ct_loss:
#             ct_loss= self.infonce(all_repr, text_output)

#         #  B, L, 384
#         """for bert"""
#         cross_txt_encoder = self.img2txt_attention(all_repr, text_output, extended_txt_mask)
#         cross_txt_output_layer = cross_txt_encoder[-1]

#         """for graph"""
#         cross_encoder = self.txt2img_attention(text_output, all_repr, extended_img_mask)
